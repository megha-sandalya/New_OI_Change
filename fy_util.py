...
# ('inputVal--> ', '{"201": 1608529162, "24": 0.0325, "26": 0.0125, "202": 7208, "20": 20075.0, "19": 38701.0, "33": 10000000.0, "23": 0.035, "34": 2, "0": 2167, "3": 48178, "27": {"28": [{"31": 0.01, "30": 22180, "35": 29}, {"31": 0.0075, "30": 8549, "35": 15}, {"31": 0.005, "30": 6916, "35": 18}, {"31": 0.0025, "30": 1056, "35": 4}, {"31": 0.0, "30": 0, "35": 0}], "29": [{"31": 0.0125, "30": 251, "35": 2}, {"31": 0.015, "30": 9330, "35": 22}, {"31": 0.0175, "30": 3511, "35": 14}, {"31": 0.02, "30": 786, "35": 13}, {"31": 0.0225, "30": 632, "35": 6}]}, "4": 0.0125, "7": 249, "6": 0.035, "9": 0.016358, "8": 1608529127, "25": 0.035}')
		# pdb.set_trace()
		...
		# pdb.set_trace()
		# ('inputVal--> ', '{"201": 96.8425, "dl": 96.8425, "ft": "10128001011252-2003-1608508800", "dh": 0.0, "h": 96.8425, "c": 96.8425, "o": 96.8425, "34": 2, "t": 1608528960, "229": 0, "v": 0, "l": 96.8425, "221": 96.8425, "vtt": 0}')
		...
		# ('fileDataTV-->1030 ', '{"fp": 13380000, "201": 1608528622, "202": 7202, "ft": "10128001011272-2003-1608508800", "dhi": 9, "fv": 1, "dlo": 9, "43": 1, "34": 2, "oi": 9, "ch": 9.0, "pv": "0.0"}')
		# ('inputVal--> ', '{"fp": 25000, "ft": 9168, "fv": 10, "201": 1608528390, "202": 7202, "34": 2, "pv": "0.0", "dhi": 81754, "oi": 81754, "43": 1, "dlo": 81116}')
		if fyMemC.K_MEMC_OI_TOKEN in inputJSKeys and fyMemC.K_MEMC_OI_FILLP in inputJSKeys and fyMemC.K_MEMC_OI_FILLVOL in inputJSKeys and fyMemC.K_MEMC_OI in inputJSKeys and fyMemC.K_MEMC_OI_DAYHI in inputJSKeys and fyMemC.K_MEMC_OI_DAYLO in inputJSKeys:
			# print "getting data from file"
			#('inputVal--> ', '{"fp": 131073, "201": 1608528957, "202": 7202, "ft": "987800000-2003-1608508800", "dhi": 916258816, "fv": 916258817, "dlo": 118882305, "43": 0, "34": 2, "oi": 1458110465, "ch": 1458110465.0, "pv": "0.0"}')
			tokenMinDict = {
	...
	try:
		...
		for eachToken in inputDict:
			...
			if int(inputDict[eachToken][fyCmnDef.K_BCH_PACKT_CODE]) == int(nseConf.NSE_T_CODE_7207) or int(inputDict[eachToken][fyCmnDef.K_BCH_PACKT_CODE]) == int(nseConf.NSE_T_CODE_7208):
				...
				if nocache == False:
					cacheConn.set(memcTVKey, json.dumps(tokenMinDict), ex=86400)
				# print("tokenMinDict ",tokenMinDict)
				# (('tokenMinDict ', {'dl': 0.065, 'ft': '10122112311012-2003-1608508800', 'dh': 0.15, 201: 0.115, 34: 2, 221: 0.085, 'c': 0.115, 229: 0, 'h': 0.15, 'l': 0.065, 'o': 0.085, 't': 1608528360, 'v': 310, 'vtt': 310})
	...
	try:
		...
		for eachToken in inputDict:
			...
			if eachToken in minValDict:
				...
				# ('fileName in fy_util-> ', '/home/ec2-user/fy_var/temp_nse_init/CD/20210131/10128001011200-2003-1608508800.json')

				# ('fileName229--> ', '/home/ec2-user/fy_var/temp_nse_init/CD/20210131/10122012299167-2003-1608508800.json')
				if os.path.exists(fileName) == True:
					try:
						with open(fileName, "rb") as dataFP:
							fileDataTV = dataFP.read()
							dataFP.close()
							if len(fileDataTV) > 0:
								# print("fileDataTV-->1030 ", fileDataTV)
								# ('fileDataTV-->1030 ', '{"fp": 13380000, "201": 1608528622, "202": 7202, "ft": "10128001011272-2003-1608508800", "dhi": 9, "fv": 1, "dlo": 9, "43": 1, "34": 2, "oi": 9, "ch": 9.0, "pv": "0.0"}')
								#sys.exit() ## For testing comment it in ** LIVE **
